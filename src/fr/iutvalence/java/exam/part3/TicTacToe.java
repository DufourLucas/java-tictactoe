...
public class TicTacToe
{
	...
	public void start()
	{
		for (int turn = 0; turn < this.cells.length * this.cells.length; turn++)
		{
			...
			else if (turn == (this.cells.length * this.cells.length) - 1)
